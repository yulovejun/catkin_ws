...
void MoveL_Callback(const rm_msgs::MoveL msg)
{
    ...
    std::cout<<"*********************************************************************"<<std::endl;
    ROS_INFO("Target position: px=%f, py=%f, pz=%f", target.px, target.py, target.pz);
    ROS_INFO("Target orientation: rx=%f, ry=%f, rz=%f", target.rx, target.ry, target.rz);
    ROS_INFO("Speed: %d%%", static_cast<int>(speed));
    std::cout<<"++++++++++++++++++++++++++++++++++++++++++++++++++++"<<std::endl;
    std::cout << "Target position: px=" << target.px<< ", py=" << target.py<< ", pz=" << target.pz << std::endl;
    std::cout << "Target orientation: rx=" << target.rx<< ", ry=" << target.ry << ", rz=" << target.rz << std::endl;
