...
import torch
from object_pose.msg import ObjectInfo
        ...
        if det is not None and len(det):
            ...
            for *xyxy, conf, class_id in reversed(det):
                ...
                if view_img:
                    ...
                    object_info_msg.object_class = self.yolov5['class_name'][class_id]
        ...
        while True:
            ...
            if xyxy_list:
                for i in range(len(xyxy_list)):
                    ...
                    object_info_msg.x = camera_xyz[0]
                    object_info_msg.y = camera_xyz[1]
                    object_info_msg.z = camera_xyz[2]
