...
(cl:defmethod cl:initialize-instance :after ((m <ObjectInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vi_grab-msg:<ObjectInfo> is deprecated: use vi_grab-msg:ObjectInfo instead.")))

(cl:ensure-generic-function 'object_class-val :lambda-list '(m))
(cl:defmethod object_class-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vi_grab-msg:object_class-val is deprecated.  Use vi_grab-msg:object_class instead.")
  (object_class m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vi_grab-msg:x-val is deprecated.  Use vi_grab-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vi_grab-msg:y-val is deprecated.  Use vi_grab-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vi_grab-msg:z-val is deprecated.  Use vi_grab-msg:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ObjectInfo>)))
  ...
  "3fb8ba78b5949ec9fd9b6e9dd65602ad")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ObjectInfo)))
  "Returns md5sum for a message object of type 'ObjectInfo"
  "3fb8ba78b5949ec9fd9b6e9dd65602ad")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObjectInfo>)))
  ...
  (cl:format cl:nil "string object_class  ~%float64 x            ~%float64 y            ~%float64 z ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObjectInfo)))
  "Returns full string definition for message of type 'ObjectInfo"
  (cl:format cl:nil "string object_class  ~%float64 x            ~%float64 y            ~%float64 z ~%~%~%"))
