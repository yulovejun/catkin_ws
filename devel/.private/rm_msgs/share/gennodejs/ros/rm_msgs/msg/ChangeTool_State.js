...
class ChangeTool_State {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ChangeTool_State(null);
  ...
  static datatype() {
    ...
    return 'rm_msgs/ChangeTool_State';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChangeTool_State(null);
...
module.exports = ChangeTool_State;
