...
class ChangeWorkFrame_State {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ChangeWorkFrame_State(null);
  ...
  static datatype() {
    ...
    return 'rm_msgs/ChangeWorkFrame_State';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChangeWorkFrame_State(null);
...
module.exports = ChangeWorkFrame_State;
