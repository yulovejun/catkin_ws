...
(cl:defmethod cl:initialize-instance :after ((m <Tool_Digital_Output>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tool_Digital_Output)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rm_msgs-msg:<Tool_Digital_Output> is deprecated: use rm_msgs-msg:Tool_Digital_Output instead.")))
